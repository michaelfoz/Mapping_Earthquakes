...
// ________________________________________________________________________________________________________________________________________________
// [Self-note: 7th code added commented out; this code will now be in separate file ("cities.js"); replaced with "10th code added"]
// (7th code added):
...
// ________________________________________________________________________________________________________________________________________________
// [Self-note: 9th code added commented out; refer to "11th code added"]
// (9th code added):
// Loop through the cities array and create one marker for each city.
// cities.forEach(function(city) {
//     console.log(city)
...
cityData.forEach(function(city) {
    ...
    // (12th code added--bind a popup to the marker; format the population with a thousands separator):
    .bindPopup("<h2>" + city.city + ", " + city.state + "</h2> <hr> <h3>Population " + city.population.toLocaleString() + "</h3>")
    .addTo(map);
});

// ________________________________________________________________________________________________________________________________________________
// [Self-note: 6th code added commented out; multiple points will be added to the map; refer to "9th code added"]
// (6th code added): 
