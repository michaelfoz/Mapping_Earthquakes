// Module 13.5.6: Map GeoJSON Polygons
// https://courses.bootcampspot.com/courses/1225/pages/13-dot-5-6-map-geojson-polygons?module_item_id=499220
...
// (5) Accessing the Toronto Neighborhoods GeoJSON URL.
let torontoHoods = "https://raw.githubusercontent.com/michaelfoz/Mapping_Earthquakes/Mapping_GeoJSON_Polygons/torontoNeighborhoods.json"

// (6) Grabbing our GeoJSON data.
d3.json(torntoHoods).then(function(data) {
    console.log(data);
// Creating a GeoJSON layer with the retrieved data.
L.geoJSON(data).addTo(map);
});

//JSON file broken/not working